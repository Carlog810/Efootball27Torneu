...
export function StandingsTable({
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="overflow-x-auto max-md:[-webkit-mask-image:linear-gradient(to_right,black_calc(100%-28px),transparent)] max-md:[mask-image:linear-gradient(to_right,black_calc(100%-28px),transparent)]">
